...
class IpAdapter(fprime_gds.common.communication.adapters.base.BaseAdapter):
    ...
    def __init__(
        self, address, port, server=True, keepalive_interval=0.5, reuse_address=True
    ):
        """
    ...
    @classmethod
    def check_arguments(
        cls, address, port, server=True, keepalive_interval=0.5, reuse_address=True
    ):
        """
...
class UdpHandler(IpHandler):
    ...
    def __init__(
        ...
        port,
        server=True,
        logger=logging.getLogger("udp_handler"),
        reuse_address=True,
    ):
        """
