    ...
    def generate_and_compare(self, seq_filename, expected_bin_filename):
        ...
        try:
            seqgen.generateSequence(
                str(input_file), str(output_file), str(self.dictionary), self.timebase
            )

            # Compare generated file with expected
            self.assertTrue(
                output_file.exists(), f"Output file was not created: {output_file}"
            )
            ...
            self.assertTrue(
                files_match, f"Generated binary does not match expected: {seq_filename}"
            )
...
class TestSequenceErrors(unittest.TestCase):
    ...
    def test_bad_command(self):
        ...
        self.generate_and_check_error(
            "simple_bad_sequence.seq", "simple_bad_sequence_error.txt"
        )

    def test_invalid_time_format(self):
        """Test error on invalid time format."""
        self.generate_and_check_error(
            "invalid_time_format.seq", "invalid_time_format_error.txt"
        )

    def test_invalid_missing_command(self):
        """Test error when command mnemonic is missing."""
        self.generate_and_check_error(
            "invalid_missing_command.seq", "invalid_missing_command_error.txt"
        )

    def test_invalid_time_descriptor(self):
        """Test error on invalid time descriptor (not R or A)."""
        self.generate_and_check_error(
            "invalid_time_descriptor.seq", "invalid_time_descriptor_error.txt"
        )
    ...
    def test_invalid_array_unclosed(self):
        ...
        self.generate_and_check_error(
            "invalid_array_unclosed.seq", "invalid_array_unclosed_error.txt"
        )

    def test_invalid_array_missing_comma(self):
        """Test error on missing comma in array."""
        self.generate_and_check_error(
            "invalid_array_missing_comma.seq", "invalid_array_missing_comma_error.txt"
        )

    def test_invalid_object_unclosed(self):
        """Test error on unclosed object brace."""
        self.generate_and_check_error(
            "invalid_object_unclosed.seq", "invalid_object_unclosed_error.txt"
        )

    def test_invalid_object_missing_colon(self):
        """Test error on missing colon in object."""
        self.generate_and_check_error(
            "invalid_object_missing_colon.seq", "invalid_object_missing_colon_error.txt"
        )
